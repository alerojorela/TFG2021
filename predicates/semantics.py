...
def is_qualia(syn1, syn2):
    ...
    name1 = syn1.name()
    name2 = syn2.name()
    if (name1 in qualia and (qualia[name1]['agentive'] == name2 or qualia[name1]['telic'] == name2)) or (name2 in qualia and (qualia[name2]['agentive'] == name1 or qualia[name2]['telic'] == name1)):
...
""" funciones de DE
    es muy difícil determinar antecedente, que no ha de ser inmediato
    requiere ontología

    tipos de relaciones DE(arg1, arg2)
        merónimos
            material
            parte
        entidades o no
    ...
    ejemplo "La tapa de latón de la caja de mi tía de Toledo"
        tapa latón caja agujas coser mi tía Toledo
    ...
    por cierto que realmente
        TENER +-animado +-alienable
            POSEER +animado +alienable
                ? poseo un ojo
                * la caja posee una tapa
                * la caja posee una carta
"""
